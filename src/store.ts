...
class AppStore {
  ...
  public store;
  constructor (
    apiService: IMovieDatabaseService<TMDBMovie, TMDBStreamProvider>
  ) {
    ...
    this.store = new Vuex.Store({
      ...
      getters: {
        ...
        getCurrentUserDocumentId: (state): string =>
          state.currentUserDocumentId,
        ...
        getDurationCategories: (state): Array<string> =>
...
const store = new AppStore(tmdb).store;
